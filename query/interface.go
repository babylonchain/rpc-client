...
type BabylonQueryClient interface {
	...
	QueryBTCCheckpoint(f func(ctx context.Context, queryClient btcctypes.QueryClient))
	BTCCheckpointParams() (*btcctypes.Params, error)
	...
	QueryCheckpointing(f func(ctx context.Context, queryClient checkpointingtypes.QueryClient))
	...
	// APIs for Epoching
	QueryEpoching(f func(ctx context.Context, queryClient epochingtypes.QueryClient))
	...
	// APIs for Monitor
	QueryMonitor(f func(ctx context.Context, queryClient monitortypes.QueryClient))
	...
	QueryZoneConcierge(f func(ctx context.Context, queryClient zctypes.QueryClient))
	FinalizedConnectedChainInfo(chainID string) (*zctypes.QueryFinalizedChainInfoResponse, error)
	ConnectedChainInfo(chainID string) (*zctypes.ChainInfo, error)
	...
	// APIs for Staking
	QueryStaking(f func(ctx context.Context, queryClient stakingtypes.QueryClient))
	StakingParams() (*stakingtypes.Params, error)
